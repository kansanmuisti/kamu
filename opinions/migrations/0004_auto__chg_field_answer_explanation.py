...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('opinions_answer', 'explanation', self.gf('django.db.models.fields.TextField')(null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Answer.explanation'
        db.alter_column('opinions_answer', 'explanation', self.gf('django.db.models.fields.TextField')())
