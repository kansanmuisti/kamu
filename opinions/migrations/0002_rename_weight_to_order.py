...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('opinions_question', 'weight', 'order')
        db.alter_column('opinions_question', 'order', models.IntegerField())
        db.rename_column('opinions_option', 'weight', 'order')
        pass
    
    
    def backwards(self, orm):
        db.rename_column('opinions_question', 'order', 'weight')
        db.alter_column('opinions_question', 'weight', models.IntegerField(unique=True))
        db.rename_column('opinions_option', 'order', 'weight')
        pass
