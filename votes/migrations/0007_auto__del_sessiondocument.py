...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('votes_sessiondocument', (
            ...
            ('url_name', self.gf('django.db.models.fields.SlugField')(max_length=20, unique=True, db_index=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, db_index=True)),
