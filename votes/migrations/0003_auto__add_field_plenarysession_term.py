...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlenarySession.term'
        db.add_column('votes_plenarysession', 'term', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['votes.Term'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'PlenarySession.term'
        db.delete_column('votes_plenarysession', 'term_id')
    ...
    models = {
        ...
        'votes.plenarysession': {
            ...
            'term': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['votes.Term']", 'null': 'True'}),
