...
class Migration(SchemaMigration):
    ...
    models = {
        'social.tweet': {
            ...
            'tweet_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '25'}),
        ...
        'votes.membertweet': {
            'Meta': {'object_name': 'MemberTweet', '_ormbases': ['social.Tweet']},
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['votes.Member']"}),
            'tweet_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['social.Tweet']", 'unique': 'True', 'primary_key': 'True'})
        },
        'votes.minutes': {
