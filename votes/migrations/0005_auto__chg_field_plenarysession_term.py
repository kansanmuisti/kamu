...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlenarySession.term'
        db.alter_column('votes_plenarysession', 'term_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['votes.Term']))
    
    
    def backwards(self, orm):
        
        # Changing field 'PlenarySession.term'
        db.alter_column('votes_plenarysession', 'term_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['votes.Term'], null=True))
