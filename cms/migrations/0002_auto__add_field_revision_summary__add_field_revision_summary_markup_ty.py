...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cms_revision', 'summary', self.gf('cms.markupfield.fields.MarkupField')(default='', rendered_field=True, blank=True), keep_default=False)

        # Adding field 'Revision.summary_markup_type'
        db.add_column('cms_revision', 'summary_markup_type', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'Revision._summary_rendered'
        db.add_column('cms_revision', '_summary_rendered', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Revision.summary'
        db.delete_column('cms_revision', 'summary')

        # Deleting field 'Revision.summary_markup_type'
        db.delete_column('cms_revision', 'summary_markup_type')

        # Deleting field 'Revision._summary_rendered'
        db.delete_column('cms_revision', '_summary_rendered')
