...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('cms', ['Content'])

        # Adding model 'Revision'
        db.create_table('cms_revision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Content'])),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('data', self.gf('cms.markupfield.fields.MarkupField')(rendered_field=True)),
            ('data_markup_type', self.gf('django.db.models.fields.CharField')(default=None, max_length=30)),
            ('_data_rendered', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('cms', ['Revision'])

        # Adding model 'Cache'
        db.create_table('cms_cache', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Item'])),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Content'])),
            ('revision', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Revision'])),
        ))
        db.send_create_signal('cms', ['Cache'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('cms_newsitem')

        # Deleting model 'Content'
        db.delete_table('cms_content')

        # Deleting model 'Revision'
        db.delete_table('cms_revision')

        # Deleting model 'Cache'
        db.delete_table('cms_cache')
