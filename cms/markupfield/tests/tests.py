...
class MarkupFieldTestCase(TestCase):
    ...
    def test_from_database(self):
        ...
        self.assertEqual(str(p1.body), '<p><strong>markdown</strong></p>')

    ## Assignment ##
    def test_body_assignment(self):
        self.rp.body = '**ReST**'
        self.rp.save()
        self.assertEqual(str(self.rp.body), '<p><strong>ReST</strong></p>\n')

    def test_raw_assignment(self):
        self.rp.body.raw = '*ReST*'
        self.rp.save()
        self.assertEqual(str(self.rp.body), '<p><em>ReST</em></p>\n')
    ...
    def test_escape_html(self):
        ...
        self.assertEqual(str(self.xss_post.comment.rendered), '<p>&lt;script&gt;alert(&#39;xss&#39;);&lt;/script&gt;</p>')
...
class MarkupWidgetTests(TestCase):
    ...
    def test_markuptextarea_render(self):
        ...
        self.assertEqual(str(af['normal_field']), '<textarea id="id_normal_field" rows="10" cols="40" name="normal_field">**normal**</textarea>')
    ...
    def test_no_markup_type_field_if_set(self):
        ...
        self.assertTrue('markdown_field_markup_type' not in list(ArticleForm().fields.keys()))
