...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KeywordActivity'
        db.create_table(u'parliament_keywordactivity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.MemberActivity'])),
            ('keyword', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.Keyword'])),
        ))
        db.send_create_signal('parliament', ['KeywordActivity'])

        # Adding unique constraint on 'KeywordActivity', fields ['activity', 'keyword']
        db.create_unique(u'parliament_keywordactivity', ['activity_id', 'keyword_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'KeywordActivity', fields ['activity', 'keyword']
        db.delete_unique(u'parliament_keywordactivity', ['activity_id', 'keyword_id'])

        # Deleting model 'KeywordActivity'
        db.delete_table(u'parliament_keywordactivity')
