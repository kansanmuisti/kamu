...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MemberActivity.member'
        db.alter_column(u'parliament_memberactivity', 'member_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.Member'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MemberActivity.member'
        raise RuntimeError("Cannot reverse this migration. 'MemberActivity.member' and its values cannot be restored.")
