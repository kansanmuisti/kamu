...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'parliament_keyword', ['name'])

        # Adding field 'Keyword.name_en'
        db.add_column(u'parliament_keyword', 'name_en',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Keyword.name_fi'
        db.add_column(u'parliament_keyword', 'name_fi',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Keyword.name_en'
        db.delete_column(u'parliament_keyword', 'name_en')

        # Deleting field 'Keyword.name_fi'
        db.delete_column(u'parliament_keyword', 'name_fi')

        # Adding unique constraint on 'Keyword', fields ['name']
        db.create_unique(u'parliament_keyword', ['name'])
    ...
    models = {
        ...
        'parliament.keyword': {
            ...
            'name_en': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'name_fi': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '128', 'null': 'True', 'blank': 'True'})
        },
