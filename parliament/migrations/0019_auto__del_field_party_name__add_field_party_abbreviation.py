...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'parliament_party', 'name', 'abbreviation')
        db.rename_column(u'parliament_party', 'full_name', 'name')

    def backwards(self, orm):
        db.rename_column(u'parliament_party', 'name', 'full_name')
        db.rename_column(u'parliament_party', 'abbreviation', 'name')
