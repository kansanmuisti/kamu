...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlenarySessionItem.nr_votes'
        db.add_column('parliament_plenarysessionitem', 'nr_votes', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True), keep_default=False)

        # Adding field 'PlenarySessionItem.nr_statements'
        db.add_column('parliament_plenarysessionitem', 'nr_statements', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlenarySessionItem.nr_votes'
        db.delete_column('parliament_plenarysessionitem', 'nr_votes')

        # Deleting field 'PlenarySessionItem.nr_statements'
        db.delete_column('parliament_plenarysessionitem', 'nr_statements')
