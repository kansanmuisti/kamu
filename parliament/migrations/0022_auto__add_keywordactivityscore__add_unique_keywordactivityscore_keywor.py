...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'KeywordActivityScore'
        db.create_table(u'parliament_keywordactivityscore', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keyword', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.Keyword'])),
            ('term', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.Term'], null=True)),
            ('score', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('calc_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('parliament', ['KeywordActivityScore'])

        # Adding unique constraint on 'KeywordActivityScore', fields ['keyword', 'term']
        db.create_unique(u'parliament_keywordactivityscore', ['keyword_id', 'term_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'KeywordActivityScore', fields ['keyword', 'term']
        db.delete_unique(u'parliament_keywordactivityscore', ['keyword_id', 'term_id'])

        # Deleting model 'KeywordActivityScore'
        db.delete_table(u'parliament_keywordactivityscore')
    ...
    models = {
        ...
        'parliament.keywordactivityscore': {
            'Meta': {'unique_together': "(('keyword', 'term'),)", 'object_name': 'KeywordActivityScore'},
            'calc_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keyword': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['parliament.Keyword']"}),
            'score': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'term': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['parliament.Term']", 'null': 'True'})
        },
        'parliament.member': {
        ...
        'parliament.party': {
            ...
            'abbreviation': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10', 'db_index': 'True'}),
        ...
        'parliament.plenarysessionitem': {
            ...
            'processing_stage': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        'parliament.plenaryvote': {
            ...
            'plsess': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['parliament.PlenarySession']"}),
            'plsess_item': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'plenary_votes'", 'null': 'True', 'to': "orm['parliament.PlenarySessionItem']"}),
        ...
        'parliament.speakerassociation': {
            'Meta': {'object_name': 'SpeakerAssociation'},
            'begin': ('django.db.models.fields.DateField', [], {}),
            'end': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['parliament.Member']"}),
