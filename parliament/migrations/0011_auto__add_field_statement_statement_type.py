...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'parliament_statement', 'statement_type',
                      self.gf('django.db.models.fields.CharField')(default='normal', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Statement.statement_type'
        db.delete_column(u'parliament_statement', 'statement_type')
