...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MinistryAssociation'
        db.create_table(u'parliament_ministryassociation', (
            ...
            ('end', self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True)),
        ...
        db.send_create_signal('parliament', ['MinistryAssociation'])

        # Adding field 'Member.summary'
        db.add_column(u'parliament_member', 'summary',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding index on 'CommitteeAssociation', fields ['end']
        db.create_index(u'parliament_committeeassociation', ['end'])


    def backwards(self, orm):
        # Removing index on 'CommitteeAssociation', fields ['end']
        db.delete_index(u'parliament_committeeassociation', ['end'])

        # Deleting model 'MinistryAssociation'
        db.delete_table(u'parliament_ministryassociation')

        # Deleting field 'Member.summary'
        db.delete_column(u'parliament_member', 'summary')
