...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename statement_type -> type (concluded that reserved words are not dangerous)
        db.rename_column(u'parliament_statement', u'statement_type', u'type')

    def backwards(self, orm):
        db.rename_column(u'parliament_statement', u'type', u'statement_type')        
