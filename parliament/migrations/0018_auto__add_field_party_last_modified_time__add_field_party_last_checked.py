...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Party.last_modified_time'
        db.add_column(u'parliament_party', 'last_modified_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Party.last_checked_time'
        db.add_column(u'parliament_party', 'last_checked_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PlenaryVote.last_modified_time'
        db.add_column(u'parliament_plenaryvote', 'last_modified_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PlenaryVote.last_checked_time'
        db.add_column(u'parliament_plenaryvote', 'last_checked_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'Document.update_time'
        db.delete_column(u'parliament_document', 'update_time')

        # Adding field 'Document.last_modified_time'
        db.add_column(u'parliament_document', 'last_modified_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Document.last_checked_time'
        db.add_column(u'parliament_document', 'last_checked_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Member.last_modified_time'
        db.add_column(u'parliament_member', 'last_modified_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Member.last_checked_time'
        db.add_column(u'parliament_member', 'last_checked_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'PlenarySession.import_time'
        db.delete_column(u'parliament_plenarysession', 'import_time')

        # Adding field 'PlenarySession.last_modified_time'
        db.add_column(u'parliament_plenarysession', 'last_modified_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'PlenarySession.last_checked_time'
        db.add_column(u'parliament_plenarysession', 'last_checked_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Committee.last_modified_time'
        db.add_column(u'parliament_committee', 'last_modified_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Committee.last_checked_time'
        db.add_column(u'parliament_committee', 'last_checked_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Party.last_modified_time'
        db.delete_column(u'parliament_party', 'last_modified_time')

        # Deleting field 'Party.last_checked_time'
        db.delete_column(u'parliament_party', 'last_checked_time')

        # Deleting field 'PlenaryVote.last_modified_time'
        db.delete_column(u'parliament_plenaryvote', 'last_modified_time')

        # Deleting field 'PlenaryVote.last_checked_time'
        db.delete_column(u'parliament_plenaryvote', 'last_checked_time')

        # Adding field 'Document.update_time'
        db.add_column(u'parliament_document', 'update_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Document.last_modified_time'
        db.delete_column(u'parliament_document', 'last_modified_time')

        # Deleting field 'Document.last_checked_time'
        db.delete_column(u'parliament_document', 'last_checked_time')

        # Deleting field 'Member.last_modified_time'
        db.delete_column(u'parliament_member', 'last_modified_time')

        # Deleting field 'Member.last_checked_time'
        db.delete_column(u'parliament_member', 'last_checked_time')


        # User chose to not deal with backwards NULL issues for 'PlenarySession.import_time'
        raise RuntimeError("Cannot reverse this migration. 'PlenarySession.import_time' and its values cannot be restored.")
        # Deleting field 'PlenarySession.last_modified_time'
        db.delete_column(u'parliament_plenarysession', 'last_modified_time')

        # Deleting field 'PlenarySession.last_checked_time'
        db.delete_column(u'parliament_plenarysession', 'last_checked_time')

        # Deleting field 'Committee.last_modified_time'
        db.delete_column(u'parliament_committee', 'last_modified_time')

        # Deleting field 'Committee.last_checked_time'
        db.delete_column(u'parliament_committee', 'last_checked_time')
    ...
    models = {
        'parliament.committee': {
            ...
            'last_checked_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'last_modified_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        'parliament.documentprocessingstage': {
            'Meta': {'ordering': "('doc', 'index')", 'unique_together': "(('doc', 'stage'), ('doc', 'index'))", 'object_name': 'DocumentProcessingStage'},
