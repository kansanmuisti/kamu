...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'parliament_documentsignature', (
        ...
        db.send_create_signal('parliament', ['DocumentSignature'])

        # Adding unique constraint on 'DocumentSignature', fields ['doc', 'member']
        db.create_unique(u'parliament_documentsignature', ['doc_id', 'member_id'])

        # Adding model 'DocumentProcessingStage'
        db.create_table(u'parliament_documentprocessingstage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('doc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.Document'])),
            ('index', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('stage', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('parliament', ['DocumentProcessingStage'])

        # Adding unique constraint on 'DocumentProcessingStage', fields ['doc', 'stage']
        db.create_unique(u'parliament_documentprocessingstage', ['doc_id', 'stage'])

        # Adding unique constraint on 'DocumentProcessingStage', fields ['doc', 'index']
        db.create_unique(u'parliament_documentprocessingstage', ['doc_id', 'index'])

        # Adding unique constraint on 'SocialUpdateActivity', fields ['update']
        db.create_unique(u'parliament_socialupdateactivity', ['update_id'])

        # Adding unique constraint on 'RebelVoteActivity', fields ['vote']
        db.create_unique(u'parliament_rebelvoteactivity', ['vote_id'])

        # Adding unique constraint on 'StatementActivity', fields ['statement']
        db.create_unique(u'parliament_statementactivity', ['statement_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StatementActivity', fields ['statement']
        db.delete_unique(u'parliament_statementactivity', ['statement_id'])

        # Removing unique constraint on 'RebelVoteActivity', fields ['vote']
        db.delete_unique(u'parliament_rebelvoteactivity', ['vote_id'])

        # Removing unique constraint on 'SocialUpdateActivity', fields ['update']
        db.delete_unique(u'parliament_socialupdateactivity', ['update_id'])

        # Removing unique constraint on 'DocumentProcessingStage', fields ['doc', 'index']
        db.delete_unique(u'parliament_documentprocessingstage', ['doc_id', 'index'])

        # Removing unique constraint on 'DocumentProcessingStage', fields ['doc', 'stage']
        db.delete_unique(u'parliament_documentprocessingstage', ['doc_id', 'stage'])

        # Removing unique constraint on 'DocumentSignature', fields ['doc', 'member']
        db.delete_unique(u'parliament_documentsignature', ['doc_id', 'member_id'])

        # Deleting model 'DocumentSignature'
        db.delete_table(u'parliament_documentsignature')

        # Deleting model 'DocumentProcessingStage'
        db.delete_table(u'parliament_documentprocessingstage')
