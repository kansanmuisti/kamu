...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SocialUpdateActivity'
        db.create_table(u'parliament_socialupdateactivity', (
            ...
            ('update', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social.Update'])),
        ))
        db.send_create_signal('parliament', ['SocialUpdateActivity'])

        # Adding model 'RebelVoteActivity'
        db.create_table(u'parliament_rebelvoteactivity', (
            (u'memberactivity_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['parliament.MemberActivity'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('parliament', ['StatementActivity'])

        # Deleting field 'MemberActivity.weight'
        db.delete_column(u'parliament_memberactivity', 'weight')

        # Deleting field 'MemberActivity.date'
        db.delete_column(u'parliament_memberactivity', 'date')
    ...
    def backwards(self, orm):
        # Deleting model 'SocialUpdateActivity'
        db.delete_table(u'parliament_socialupdateactivity')

        # Deleting model 'RebelVoteActivity'
        db.delete_table(u'parliament_rebelvoteactivity')

        # Deleting model 'StatementActivity'
        db.delete_table(u'parliament_statementactivity')

        # Adding field 'MemberActivity.weight'
        db.add_column(u'parliament_memberactivity', 'weight',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'MemberActivity.date'
        raise RuntimeError("Cannot reverse this migration. 'MemberActivity.date' and its values cannot be restored.")
        # Deleting field 'MemberActivity.time'
        db.delete_column(u'parliament_memberactivity', 'time')


        # Changing field 'PlenaryVote.setting'
        db.alter_column(u'parliament_plenaryvote', 'setting', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'parliament.rebelvoteactivity': {
            ...
            u'memberactivity_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['parliament.MemberActivity']", 'unique': 'True', 'primary_key': 'True'}),
            'vote': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['parliament.Vote']"})
        },
        'parliament.seat': {
        ...
        'parliament.socialupdateactivity': {
            ...
            u'memberactivity_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['parliament.MemberActivity']", 'unique': 'True', 'primary_key': 'True'}),
            'update': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social.Update']"})
        },
        ...
        'parliament.statementactivity': {
            ...
            u'memberactivity_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['parliament.MemberActivity']", 'unique': 'True', 'primary_key': 'True'}),
            'statement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['parliament.Statement']"})
        },
        'parliament.term': {
