...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'parliament_committee', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=500, null=True)),
            ('origin_id', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True)),
            ('current', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('url_name', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True)),
        ))
        db.send_create_signal('parliament', ['Committee'])


    def backwards(self, orm):
        # Deleting model 'Committee'
        db.delete_table(u'parliament_committee')
