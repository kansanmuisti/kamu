...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlenarySessionItemDocument'
        db.create_table(u'parliament_plenarysessionitemdocument', (
        ...
        db.send_create_signal('parliament', ['PlenarySessionItemDocument'])

        # Adding unique constraint on 'PlenarySessionItemDocument', fields ['item', 'doc']
        db.create_unique(u'parliament_plenarysessionitemdocument', ['item_id', 'doc_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PlenarySessionItemDocument', fields ['item', 'doc']
        db.delete_unique(u'parliament_plenarysessionitemdocument', ['item_id', 'doc_id'])

        # Deleting model 'PlenarySessionItemDocument'
        db.delete_table(u'parliament_plenarysessionitemdocument')
    ...
    models = {
        ...
        'parliament.committeeassociation': {
            ...
            'role': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'})
        },
