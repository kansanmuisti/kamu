...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlenarySessionItem.sub_description'
        db.add_column('parliament_plenarysessionitem', 'sub_description', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlenarySessionItem.sub_description'
        db.delete_column('parliament_plenarysessionitem', 'sub_description')
