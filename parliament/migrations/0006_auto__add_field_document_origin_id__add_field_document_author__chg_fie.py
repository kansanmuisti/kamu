...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.origin_id'
        db.add_column(u'parliament_document', 'origin_id',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=30, db_index=True),
                      keep_default=False)

        # Adding field 'Document.author'
        db.add_column(u'parliament_document', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.Member'], null=True),
                      keep_default=False)


        # Changing field 'Document.name'
        db.alter_column(u'parliament_document', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30))
        # Adding unique constraint on 'Document', fields ['name']
        db.create_unique(u'parliament_document', ['name'])


        # Changing field 'Document.type'
        db.alter_column(u'parliament_document', 'type', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):
        # Removing unique constraint on 'Document', fields ['name']
        db.delete_unique(u'parliament_document', ['name'])

        # Deleting field 'Document.origin_id'
        db.delete_column(u'parliament_document', 'origin_id')

        # Deleting field 'Document.author'
        db.delete_column(u'parliament_document', 'author_id')


        # Changing field 'Document.name'
        db.alter_column(u'parliament_document', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Document.type'
        db.alter_column(u'parliament_document', 'type', self.gf('django.db.models.fields.CharField')(max_length=5))
