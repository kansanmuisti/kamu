...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'parliament_government', (
        ...
        db.send_create_signal('parliament', ['Government'])

        # Adding model 'GoverningParty'
        db.create_table(u'parliament_governingparty', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('party', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.Party'])),
            ('begin', self.gf('django.db.models.fields.DateField')()),
            ('end', self.gf('django.db.models.fields.DateField')(null=True)),
            ('government', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.Government'])),
        ))
        db.send_create_signal('parliament', ['GoverningParty'])


    def backwards(self, orm):
        # Deleting model 'Government'
        db.delete_table(u'parliament_government')

        # Deleting model 'GoverningParty'
        db.delete_table(u'parliament_governingparty')
    ...
    models = {
        ...
        'parliament.statement': {
            ...
            'statement_type': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
