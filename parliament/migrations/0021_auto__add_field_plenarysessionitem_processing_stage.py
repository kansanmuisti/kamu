...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlenarySessionItem.processing_stage'
        db.add_column(u'parliament_plenarysessionitem', 'processing_stage',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlenarySessionItem.processing_stage'
        db.delete_column(u'parliament_plenarysessionitem', 'processing_stage')
