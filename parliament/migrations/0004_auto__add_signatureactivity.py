...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SignatureActivity'
        db.create_table(u'parliament_signatureactivity', (
            ...
            ('signature', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.DocumentSignature'], unique=True)),
        ))
        db.send_create_signal('parliament', ['SignatureActivity'])


    def backwards(self, orm):
        # Deleting model 'SignatureActivity'
        db.delete_table(u'parliament_signatureactivity')
