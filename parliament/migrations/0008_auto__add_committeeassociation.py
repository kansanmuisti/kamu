...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommitteeAssociation'
        db.create_table(u'parliament_committeeassociation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.Member'])),
            ('committee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.Committee'])),
            ('begin', self.gf('django.db.models.fields.DateField')()),
            ('end', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
        ))
        db.send_create_signal('parliament', ['CommitteeAssociation'])


    def backwards(self, orm):
        # Deleting model 'CommitteeAssociation'
        db.delete_table(u'parliament_committeeassociation')
