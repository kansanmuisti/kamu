...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming column for 'MemberActivity.type' to match new field type.
        db.rename_column(u'parliament_memberactivity', 'type', 'type_id')
        # Changing field 'MemberActivity.type'
        db.alter_column(u'parliament_memberactivity', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parliament.MemberActivityType']))

    def backwards(self, orm):
        # Renaming column for 'MemberActivity.type' to match new field type.
        db.rename_column(u'parliament_memberactivity', 'type_id', 'type')
        # Changing field 'MemberActivity.type'
        db.alter_column(u'parliament_memberactivity', 'type', self.gf('django.db.models.fields.CharField')(max_length=5))
