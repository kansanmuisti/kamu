...
class LifestreamManager(models.Manager):
    def for_object(self, obj):
        ct = ContentType.objects.get_for_model(obj)
        return self.filter(content_type__pk=ct.id, object_id=obj.id)

class Lifestream(models.Model):
    """
    A lifestream. Lifestreams can be created per any model object.
    """
